            ...
            <div className="row mt-3">
                <div className="col-lg-9 left-contents">
                    ...
                    <div className="mt-5 cmt-container">
                        <h3 className="text-uppercase title-box-key">
                            <span>2</span> BÌNH LOẠN
                        </h3>
                        <div className="cmt-contents">
                            <div className="d-flex cmt-content">
                                ...
                                <div className="user-cmt">
                                    ...
                                    <p className="cmt">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aspernatur, aut error eveniet
                                        exercitationem nam nihil odit placeat quaerat quod recusandae sapiente sed vitae. Dolorem libero quo
                                        quod. Autem, debitis?
                                    </p>
                                </div>
                            </div>
                                            ...
                                            <div className={''}>
                                                <div className="">
                                                    <SortableContext items={tasks} strategy={verticalListSortingStrategy}>
                                                        {tasks.map((task) => {
                                                            return <Task key={task.id} task={task} id={task.id}></Task>;
                                                        })}
                                                    </SortableContext>
                                                </div>
                                            </div>
...
const Task = ({ task, id }) => {
    ...
    return (
        <div key={task.id} className="py-2 task-music" ref={setNodeRef} {...attributes} {...listeners} style={style}>
            <div className="d-flex">
                ...
                <div className="">
                    <div className="">
                        ...
                        <p className="m-0">
                            <small className="text-muted">Tên nghệ sĩ</small>
                        </p>
                    </div>
                </div>
            </div>
